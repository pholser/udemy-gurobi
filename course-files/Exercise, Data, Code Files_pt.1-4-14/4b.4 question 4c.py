...
x = m.addVars(C, lb=200, vtype=gp.GRB.CONTINUOUS, name="x")
...
m.addConstr(5*x["A"] + 7*x["B"] + 2*x["C"] + 3*x["D"] + y["Paper"] == 33000)
m.addConstr(3*x["A"] + 3*x["B"] + 1*x["C"] + 1*x["D"] + y["Glass"] == 12000)
m.addConstr(1*x["A"] + 2*x["B"] + 1*x["C"] + 4*x["D"] + y["Plastic"] == 24000)
