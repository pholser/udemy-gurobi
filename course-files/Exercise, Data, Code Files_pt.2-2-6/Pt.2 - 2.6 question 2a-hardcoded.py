...
m.setObjective(1.1*x[1] + 0.5*x[2] + 0.2*x[3] + 0.7*x[4] + 1.1*x[5] +
               0.9*x[6] + 1.0*x[7] + 1.6*x[8] + 0.8*x[9] + 0.5*x[10] +
               0.7*x[11] + 1.0*x[12])
...
m.addConstr(x[1] + x[2] + x[7] + x[8] >= 1) # Retail
m.addConstr(x[1] + x[2] + x[7] + x[8] + x[9] + x[11] + x[12] >= 3) # Total retail
m.addConstr(x[1] + x[5] + x[8] + x[10] + x[12] >= 2) # USA
m.addConstr(x[3] + x[9] >= 1) # Canada
m.addConstr(x[2] + x[4] + x[11] >= 2) # Europe
